        ...
        <PageLayout home>
            <div className='container px-3 pb-5 md:mt-[50px] pt-20 md:pt-0'>
                ...
                <List type={ListType.disc} className="mt-5">
                    <li>
                        <Image className="mt-5" src="/public/gifs/inspect vid.gif" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    </li>
                    <li>
                        Now they have stats; Health, Energy & Hunger. Villagers must now eat, sleep and heal to survive.
                    </li>
                </List>
                <Seperator />
